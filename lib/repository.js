...
class Repository {
    ...
    async init (options={}) {
        ...
        // Copy the template `documents` directory
        const documentsDestPath = this.resolvePath("documents");
        const documentsOrigPath = path.resolve(__dirname, "../repo-template/documents");
        await copyDirectory(documentsOrigPath, documentsDestPath);
    }
