...
class Repository {
    ...
    async init (options={}) {
        ...
        // Copy the template `olocs` directory
        const olocsDestPath = this.resolvePath("olocs");
        const olocsOrigPath = path.resolve(__dirname, "../repo-template/olocs");
        await copyDirectory(olocsOrigPath, olocsDestPath);
    }
