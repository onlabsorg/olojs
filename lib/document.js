...
class Document {
    ...
    async evaluate (presets={}) {
        ...
        Object.assign(context, this.locals, presets);
        content.namespace = await this._eval(context);
        content.render = () => expression.stringify(content.namespace);
        return content;
    }
        ...
        return async (context) => {
            ...
            for (let i=0; i<parsedExpressions.length; i++) {
                ...
                try {
                    ...
                    var value = this.renderError(error);
                }
