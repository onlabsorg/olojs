...
class AbstractBackend {
     ...
     */
    getDocument (docId) {
        var doc = this.documentCache[docId];
        if (!doc) {
            doc = new this.constructor.Document(this, docId);
            this.documentCache[docId] = doc;
        }
        return doc;
    }
...
AbstractBackend.Document = class {
    ...
    //
    _assertOpen () {
        if (!this.isOpen) throw new errors.DocumentClosedError(this.id);
        return this;
    }
    ...
    //
    _assertReadable () {
        if (!this.readable) throw new errors.ReadPermissionError(this.id);
        return this;
    }
    ...
    //
    _assertWritable () {
        if (!this.writable) throw new errors.WritePermissionError(this.id);
        return this;
    }
}
